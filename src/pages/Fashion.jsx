  ...
  const fetchFashion = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${backendURL}/api/getAllFashion?postType=Fashion`
      );
      if (!response.ok) throw new Error("Failed to fetch Fashion data");
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <main className="lg:w-2/3">
            <div className="ml-4 my-5">
              <h3 className="text-xl font-normal">Category : Fashion</h3>
            </div>
