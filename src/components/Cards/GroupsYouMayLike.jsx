  ...
  <Link
    ...
    <div className="card bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="card-content p-4">
        ...
        <button className="join-button bg-red-600 px-5 py-1 rounded-md text-white text-sm transition-all  bg-Blud  duration-300 ease-out hover:scale-105 hover:bg-red-800">
          Join group
        </button>
      </div>
    </div>
